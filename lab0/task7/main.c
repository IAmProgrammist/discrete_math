...
void testCase1() {
    ...
    assert(isArraysConsistsOfDifferentElements(arrayA, arrayASize, arrayB, arrayBSize));
...
int main() {
    ...
    bool result = isArraysConsistsOfDifferentElements(arrayA, aSize, arrayB, bSize);
