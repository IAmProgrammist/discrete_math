...
void testCase1() {
    ...
    getArrayWithElementsFromANotPresentInB(arrayA, arrayASize, arrayB, arrayBSize, arrayC, &arrayCSize);
...
int main() {
    ...
    getArrayWithElementsFromANotPresentInB(arrayA, aSize, arrayB, bSize, arrayC, &cSize);
